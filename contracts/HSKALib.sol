...
library HSKALib {
    ...
    function getLecturerName(Lecturers _lecturer) public pure returns (string memory) {
    ...
    function getCourseName(Courses _course) public pure returns (string memory) {
